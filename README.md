...
````
go get github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog
````
...
````
go test -v github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog
````
Optional flags:
...
````
go test -v github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog -test.artifactory=false -test.buildTools=true
````
##### Limitation
...
````
docker login
go test -v github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog -test.artifactory=false -test.docker=true -rt.dockerRepoDomain=DOCKER_DOMAIN -rt.dockerTargetRepo=DOCKER_TARGET_REPO -rt.url=ARTIFACTORY_URL -rt.user=USERNAME -rt.password=PASSWORD
````
...
````
go test -v github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog -test.artifactory=false -test.go=true 
````
...
````
go test -v github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog -test.artifactory=false -test.nuget=true 
````
...
````
go test -v github.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli/jfrog -test.artifactory=false -test.bintray=true
````
Flags:
...
# Release Notes
The release are available on [Bintray](https://bintray.com/AlexeiVainshtein/jfrog-cli-go-modules/jfrog-cli-linux-amd64#release).
